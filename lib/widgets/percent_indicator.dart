...
class _LinearPercentIndicatorState extends State<LinearPercentIndicator> with SingleTickerProviderStateMixin {
...
class LinearPainter extends CustomPainter {
  ...
  LinearPainter({this.lineWidth, this.progress, this.progressColor, this.backgroundColor, this.linearStrokeCap = LinearStrokeCap.butt}) {
  ...
  void paint(Canvas canvas, Size size) {
    final start = Offset(size.width / 2, 0.0);
    final end = Offset(size.width / 2, size.height);
    canvas.drawLine(start, end, _paintBackground);
    canvas.drawLine(end, Offset(size.width / 2, size.height * (1 - progress)), _paintLine);
  }
